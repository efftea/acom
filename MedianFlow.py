...
out = cv2.VideoWriter('./Result/MedianFlow/5_MedianFlow.avi', fourcc, 20.0, (1280, 720))
...
while True:
    ...
    out.write(frame)
    cv2.imshow('TrackMedianFlow', frame)
...
if cap.get(cv2.CAP_PROP_FRAME_COUNT) != 0:
    print(f"Время обработки одного кадра MedianFlow: {end - start:.5f} секунд")
